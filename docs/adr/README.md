...
| 019 | Aggregate Roster, Athlete entity interne, JSONB, consolidation kernel | Accepté |
...
| 023 | Event Publication Registry Modulith — durabilité, at-least-once, cohérence éventuelle | Accepté (sprint 3) |
